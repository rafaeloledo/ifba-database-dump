CREATE DATABASE tb2 WITH ENCODING = 'UTF8' LC_COLLATE = 'pt_br.UTF8' LC_CTYPE = 'pt_br.UTF8' TEMPLATE=template0;
...
CREATE TABLE Indice(
	...
	CONSTRAINT fk_indice_pk_municipio FOREIGN KEY (CodMunicipio) REFERENCES Municipio (CodMunicipio));
